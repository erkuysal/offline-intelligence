...
| [9 — Production Hardening](phase-9-production-hardening.md) | In progress | Source/trust foundation accepted; provenance, signing, least privilege, automated gates, and safe upgrades remain |
